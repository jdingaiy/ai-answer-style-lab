...
export function buildCSS(c) {
  ...
  css+=`.markdown-body ul li{position:relative;list-style:none;}.markdown-body ul li::before{content:'•';position:absolute;right:calc(100% + ${c.markerGap}px);top:.85em;transform:translateY(-50%);font-size:${c.markerSize}px;line-height:1;color:${c.markerColor};}\n`;
