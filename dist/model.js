...
export function buildCSS(c) {
  ...
  css+=`.markdown-body figure.md-image{display:block;max-width:100%;}.markdown-body figure.md-image img{display:block;max-width:100%;height:auto;margin:0;}\n.markdown-body figure.md-image-group{display:flex;flex-wrap:nowrap;align-items:flex-start;gap:8px;overflow-x:auto;overscroll-behavior-x:contain;-webkit-overflow-scrolling:touch;scrollbar-width:thin;}\n.markdown-body figure.md-image-group img{flex:0 0 auto;width:auto;max-width:min(80%,320px);max-height:320px;object-fit:contain;}\n.markdown-body li > figure.md-image{width:100%;max-width:100%;margin-inline:0;padding-inline:0;}\n`;
